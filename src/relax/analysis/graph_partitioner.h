...
class IndexedForwardGraph {
 public:
   ...
   * \note Defined in dnnf_partitioner.cc -- its only caller is RunDNNFuse,
   *       and its body needs MappingTypeName(), which lives in that
   *       DNNFuse-only header (including it here would cycle back to this one).
   */
