...
def DNNFuseOps(profile_tune_trials: int = 0) -> tvm.ir.transform.Pass:
    ...
    Parameters
    ----------
    profile_tune_trials : int
        Number of profiling trials for the cost-oracle profiling of kFuseDepend candidates
        during partitioning. 0 (the default) disables profiling.
    ...
    """
    return _ffi_api.DNNFuseOps(profile_tune_trials)  # type: ignore
